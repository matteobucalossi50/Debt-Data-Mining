...
class debt():
        ...
        def dtstats():
                ...
                tex.see(tkinter.END)
                tex.pack()
                Button(master9,text="DISPLAY DT CONFUSION MATRIX",command=model4.dispimgDT).pack()
        ...
        def mainwindow():
            ...
            Button(frame,text="K NEAREST NEIGHBOUR ",command=model1.knnstats).grid(row=2)
            Button(frame,text="SUPPORT VECTOR MACHINES ",command=model2.svmstats).grid(row=3)
            Button(frame,text="LOGISTIC REGRESSION", command=model3.lrstats).grid(row=4)
            Button(frame,text="DECISON TREES", command=model4.dtstats).grid(row=5)
            Button(frame,text="ENSEMBALING",command=model5.estats).grid(row=6)
            Button(frame,text="RANDOM FOREST",command=model5.rfstats).grid(row=7) 
...
class mainviz():
    ...
    class mean_of_income():
        def __init__(self):
            master = Toplevel() 
             # Adding widgets to the root window 
            Label(master, text = 'Distribution of mean of family income', font =( 
              'Verdana', 15)).pack(side = TOP, pady = 10) 
    ...
    class main():
        def __init__(self):
            ...
            disp1=Button(master,text="DISTRIBUTION OF DEBT",command=mainviz.debt)
            disp1.pack()
            disp2=Button(master,text="DISTRIBUTION OF POPULATION",command=mainviz.pop)
            disp2.pack()
            disp3=Button(master,text="DISTRIBUTION OF MALE POPULATION",command=mainviz.malepop)
            disp3.pack()
            disp4=Button(master,text="DISTRIBUTION OF FEMALE POPULATION",command=mainviz.femalepop)
            disp4.pack()
            disp5=Button(master,text="DISTRIBUTION OF DIVORCE",command=mainviz.divorce)
            disp5.pack()
            disp6=Button(master,text="DISTRIBUTION OF MEAN OF FAMILY INCOME ",command=mainviz.mean_of_income)
            disp6.pack()
            disp7=Button(master,text="DISTRIBUTION OF NUMBER OF FEMALES WHO HAVE A HIGHSCHOOL DEGREE",command=mainviz.femalehs)
            disp7.pack()
            disp8=Button(master,text="DISTRIBUTION OF NUMBER WITH A HIGHSCHOOL DEGREE",command=mainviz.highschool)
            disp8.pack()
            disp9=Button(master,text="DISTRIBUTION OF HOUSEHOLD INCOME",command=mainviz.household)
            disp9.pack()
            disp10=Button(master,text="DISTRIBUTION OF MALES WITH A HIGH SCHOOL DEGREE",command=mainviz.malehs)
            disp10.pack()
            disp11=Button(master,text="DISTRIBUTION OF NUMBER OF MARRIED PEOPLE",command=mainviz.married)
            disp11.pack()
            disp12=Button(master,text="DISTRIBUTION OF MEAN OF MONTHLY MORTGAGE AND OWNER COST",command=mainviz.monthlymorg)
            disp12.pack()
            disp12=Button(master,text="DISTRIBUTION OF MEAN OF MONTHLY MORTGAGE",command=mainviz.ownercost)
            disp12.pack()
            disp13=Button(master,text="DISTRIBUTION OF RENT",command=mainviz.rentdist)
            disp13.pack()
            disp14=Button(master,text="DISTRIBUTION OF HOUSES WITH A SECOND MORTGAGE",command=mainviz.secondmorgage)
            disp14.pack()
            disp15=Button(master,text="DISTRIBUTION OF NUMBER OF PEOPLE WHO ARE SEPERATED",command=mainviz.seperated)
            disp15.pack()
...
class lastwindow():
    ...
    masterfinal.title("DEBT AND MORTGAGE AND DATA ANALYSIS")
    masterfinal.geometry("600x600")
    Label(frame,text="MAIN MENU").grid(row=4,column=4)
    
    Button(frame,text="ANALYSIS ON DEBT DATA",command=debt.mainwindow).grid(row=4,column=4)
    Button(frame,text="ANALYSIS ON RENT DATA",command=rent.mainwindow).grid(row=5,column=4)
    Button(frame,text="VIZ",command=mainviz.main).grid(row=6,column=4)
